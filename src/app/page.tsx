      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
          ...
          <p className="text-lg text-gray-500 mb-10 max-w-2xl leading-relaxed">
            SkillExchange is a community where you can teach what you know and learn what you need. Exchange skills, earn badges, and grow together.
          </p>
          ...
          <div className="flex sm:flex-row flex-col gap-4 mb-10 w-full sm:w-auto justify-center items-center">
            ...
            <Link href="/skills">
              <Button size="lg" className="bg-gray-900 text-white hover:bg-gray-800 font-semibold rounded-full px-8 h-12 shadow-md w-full sm:w-auto transition-all">
                Search Your Required Skills <ArrowRight size={18} className="ml-2" />
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative z-10">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-500 text-sm leading-relaxed px-4">Complete skill exchanges, learn new skills and upgrade your life.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                &quot;I learned Spanish in exchange for teaching web development. This experiences was amazing, and I happy to be part of this community!&quot;
              </p>
            </div>
            <div>
