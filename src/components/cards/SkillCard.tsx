      ...
      <Card className="overflow-hidden border-0 shadow-sm bg-white hover:shadow-xl transition-all duration-500 group rounded-[1.5rem] cursor-pointer relative top-0 hover:-top-2">
        ...
        <CardContent className="p-6 relative z-10">
          ...
          <div className="space-y-5">
            <div>
              <div className="flex items-center text-[11px] uppercase tracking-wider font-extrabold text-blue-600 mb-1.5">
          ...
          {post.description && (
            <p className="mt-5 text-sm text-gray-500 line-clamp-2 leading-relaxed font-medium">
              {post.description}
            </p>
          )}
        </CardContent>
        
        <CardFooter className="px-6 py-4 bg-gray-50/30 border-t border-gray-50 flex items-center justify-between relative z-10">
